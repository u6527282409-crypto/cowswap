import{a as N,b as k,x as a,r as L,j as v,K as p,h as O,R as Y,O as V,k as z,A as E,W}from"./index.js";import{n as l,c as _,o as S,r as b}from"./chunk.if-defined-Cm4VnrCK.js";import{T as A,D as F}from"./chunk.index-B8xruEqP.js";import"./chunk.index-l-pPUC4P.js";import"./chunk.index-C4zanXWC.js";import"./chunk.index-DC1lEsHD.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
